...
- When adding a new site, please copy and paste an existing site and make the following changes:
  1. Ensure `job_name` is unique (consider using `<siteshort>-blackbox`, e.g., `my-site-blackbox`).
  2. Adjust the `target_label: location` to match your specific location.
  3. Change all service references to the services you want to monitor.
  
Make sure to review all relevant fields to ensure accuracy and completeness!
